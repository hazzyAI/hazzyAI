...
<table>
  <tr>
    <td align="center" width="160"><strong>2회</strong><br><br><sub>AI 실서비스 배포</sub></td>
    <td align="center" width="160"><strong>2회</strong><br><br><sub>국가과제 수행</sub></td>
    <td align="center" width="160"><strong>5회</strong><br><br><sub>대회 수상</sub></td>
    <td align="center" width="160"><strong>2건</strong><br><br><sub>특허 등록</sub></td>
  </tr>
</table>
...
<table>
  <tr>
    <td>🔐</td><td align="left"><strong>필상 (Pillsang)</strong></td><td align="left">ML 엔지니어 — 피싱 탐지 AI 모델 설계 · 실서비스 배포</td>
  </tr>
  <tr>
    <td>🎓</td><td align="left"><strong>충남대학교 대학원</strong></td><td align="left">바이오AI융합학과 석사 (2023) · GPA 4.33 / 4.5</td>
  </tr>
  <tr>
    <td>📋</td><td align="left"><strong>국가 R&D 2회</strong></td><td align="left">딥테크 TIPS · 스케일업 TIPS</td>
  </tr>
  <tr>
    <td>🏆</td><td align="left"><strong>수상 5회</strong></td><td align="left">교외 3관 · 교내 2관</td>
  </tr>
  <tr>
    <td>📄</td><td align="left"><strong>특허 등록 2건</strong></td><td align="left">AI 관련 특허 2건</td>
  </tr>
</table>
...
![Inference](https://img.shields.io/badge/추론_10ms_이하-success?style=flat-square)
...
![MV3](https://img.shields.io/badge/Manifest_V3-4285F4?style=flat-square)
![CatBoost](https://img.shields.io/badge/CatBoost_ONNX-FFD700?style=flat-square)
![Worker](https://img.shields.io/badge/Service_Worker-555?style=flat-square)
![Detection](https://img.shields.io/badge/온디바이스_추론-success?style=flat-square)
![Stage](https://img.shields.io/badge/2단계_탐지-blueviolet?style=flat-square)
...
`Xception Fine-tuning` `알츠하이머 예측` `유전자 발현` `SOTA 대비 2% 개선`
...
**[2023] 석사 졸업논문** &nbsp; ![type](https://img.shields.io/badge/졸업논문-8B5CF6?style=flat-square)
...
**[2023] AAiCON 2023** &nbsp; ![type](https://img.shields.io/badge/학술발표-0EA5E9?style=flat-square)
...
**[2023] KSC 2023** &nbsp; ![type](https://img.shields.io/badge/학술발표-0EA5E9?style=flat-square)
...
**[2022] KDBC 2022** &nbsp; ![type](https://img.shields.io/badge/학술발표-0EA5E9?style=flat-square)
